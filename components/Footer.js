        ...
        <div className="footer">
            <div className="footer-box">
                ...
                <div className="social-container">
                    ...
                    <a
                        href="https://www.instagram.com/vaccinate_ma/"
                        target="_blank"
                        rel="noreferrer"
            ...
            <div className="footer-box">
                ...
                <p>
                    Email us at <EmailLink /> if you&apos;d like to help out.
                </p>
                <h2 className="footer-heading">Feedback</h2>
                <p>
                    Like the site? Found a bug? Have a feature idea? Get a
                    vaccine from info you found here?{' '}
                    <a
            ...
            <div className="footer-box disclaimer">
                ...
                <p>
                    This site was put together by volunteers using our best
                    efforts to assemble readily available data from public
                    sources. This site does not provide medical advice, nor does
                    it provide any type of technical advice. vaccinatema.com is
